...
<head>
    <title>SourceSphere - Home Page</title>
    <meta charset="utf-8">
...
<body id="gradient-colour-1">
            ...
            <div class="row">
                <nav class="card">
                    <div class="nav-wrapper white">
                        <ul>
                            <li><a class="waves-effect cyan btn active" href="Index.html">Home</a></li>
                            <li><a class="waves-effect cyan btn" href="UK%20News.html">UK News</a></li>
                            <li><a class="waves-effect cyan btn" href="US%20News.html">US News</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="card white">
                    <div class="card-content PRFont">Read the latest and most trustworthy news here - No 'Fake News', no tabloids, no 'Clickbait'. Just open, clear and honest news from verified sources across the internet.</div>
                </div>
                <br>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div style="margin-top: 150px" class="fixed-action-btn direction-left"><a id="Twitter_Share" class="white btn-floating btn-large waves-effect waves-light" href="https://twitter.com/intent/tweet"></a></div>
            ...
            <div class="col-sm-9">
                ...
                <a style="margin-left: 850px;" class="red fixed-action-btn waves-effect waves-light dropdown-trigger btn" href="#" data-target="sortby_filter">Sort By...<i class="small material-icons">arrow_drop_down</i></a>
                ...
                <ul id="source_filter" class="dropdown-content" tabindex="0">
                    ...
                    <li tabindex="0"><a onclick="LOAD_BBCNews()">BBC News</a></li>
                    <li tabindex="0"><a onclick="LOAD_BBCSport()">BBC Sport</a></li>
                    <li tabindex="0"><a onclick="LOAD_TheGuardian()">The Guardian</a></li>
                    <li tabindex="0"><a onclick="LOAD_TheTelegraph()">The Telegraph</a></li>
                    <li tabindex="0"><a onclick="LOAD_Independent()">The Independent</a></li>
                    ...
                    <li tabindex="0"><a onclick="LOAD_AlJazeeraENG()">Al Jazeera English</a></li>
                    <li tabindex="0"><a onclick="LOAD_Reuters()">Reuters</a></li>
                    <li tabindex="0"><a onclick="LOAD_AssociatedPress()">Associated Press</a></li>
                    <li tabindex="0"><a onclick="LOAD_TheIrishTimes()">The Irish Times</a></li>
                    <li tabindex="0"><a onclick="LOAD_TheTimesOfIndia()">The Times Of India</a></li>
                </ul>

                <a style="margin-left: 850px;" class="red fixed-action-btn waves-effect waves-light dropdown-trigger btn" href="#" data-target="source_filter">News sources...<i class="small material-icons">arrow_drop_down</i></a>
                ...
                <a style="margin-left: 850px;" class="red fixed-action-btn waves-effect waves-light dropdown-trigger btn" href="#" data-target="category_filter">Categories...<i class="small material-icons">arrow_drop_down</i></a>
    ...
    <script>
        function LOAD_LATEST() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-news,bbc-sport,the-guardian-uk,the-telegraph,independent,cbs-news,the-wall-street-journal,usa-today,abc-news,al-jazeera-english,associated-press,reuters,the-times-of-india&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
        ...
        function LOAD_POPULAR() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-news,bbc-sport,the-guardian-uk,the-telegraph,independent,cbs-news,the-wall-street-journal,usa-today,abc-news,al-jazeera-english,associated-press,reuters,the-times-of-india&sortBy=popularity&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }

        function LOAD_BBCNews() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-news&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }

        function LOAD_BBCSport() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-sport&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_TheGuardian() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=the-guardian-uk&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_TheTelegraph() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=the-telegraph&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_Independent() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=independent&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
        ...
        function LOAD_AlJazeeraENG() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=al-jazeera-english&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_Reuters() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=reuters&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_AssociatedPress() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=associated-press&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_TheIrishTimes() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=the-irish-times&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();

        }


        function LOAD_TheTimesOfIndia() {
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var myarr = JSON.parse(this.responseText);
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=the-times-of-india&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
