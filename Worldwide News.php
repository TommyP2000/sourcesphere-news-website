...
<head>
    <title>SourceSphere - Worldwide News</title>
    <meta charset="utf-8">
...
<body id="gradient-colour-4">
                ...
                <nav class="card">
                    <div class="nav-wrapper white">
                        <ul>
                            ...
                            <li><a class="waves-effect cyan btn active" href="Worldwide%20News.html">Worldwide News</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="card white">
                    <div class="card-content PRFont">Read the latest worldwide news from sources like Al Jazeera English, Associated Press, Reuters and The Times Of India</div>
                </div>
                <br>
            </div>
    ...
    <script>
        function LOAD_LATEST() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=al-jazeera-english,reuters,associated-press,the-irish-times,the-times-of-india&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
        ...
        function LOAD_POPULAR() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=al-jazeera-english,reuters,associated-press,the-irish-times,the-times-of-india&sortBy=popularity&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
