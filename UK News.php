...
<head>
    <title>SourceSphere - UK News</title>
    <meta charset="utf-8">
...
<body id="gradient-colour-2">
                ...
                <nav class="card">
                    <div class="nav-wrapper white">
                        <ul>
                            ...
                            <li><a class="waves-effect cyan btn active" href="UK%20News.html">UK News</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="card white">
                    <div class="card-content PRFont">Read the latest UK news from sources like BBC News, BBC Sport, The Guardian, The Telegraph and Independent</div>
                </div>
                <br>
            </div>
    ...
    <script>
        function LOAD_LATEST() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-news,bbc-sport,the-guardian-uk,the-telegraph,independent&sortBy=publishedAt&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
        ...
        function LOAD_POPULAR() {
            ...
            xhttp.open("GET", "https://newsapi.org/v2/top-headlines?sources=bbc-news,bbc-sport,the-guardian-uk,the-telegraph,independent&sortBy=popularity&apiKey=05730bf65e39405fa50a3345ea89ffac", true);
            xhttp.send();
